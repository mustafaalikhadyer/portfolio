  ...
  return (
    <group position={position} rotation={rotation}>
      <mesh>
        ...
        {/* OPTIMERING 1: MeshPhysicalMaterial istället för Transmission. Superlätt men ser ut som mörkt glas! */}
        ...
        {/* OPTIMERING 2: Inget "occlude" och inga CSS-blur effekter. Detta gör att HTML-koden flyter i 60fps på Mac. */}
        <Html transform distanceFactor={5} position={[0, 0, 0.05]} className="pointer-events-none">
          <div className="w-[480px] h-[680px] p-8 flex flex-col font-sans select-none text-white overflow-hidden bg-[#0a0a0a]/90 border border-cyan-500/20 rounded-2xl shadow-2xl">
...
export default function NeuralCV() {
  return (
    <section className="relative min-h-[1000px] h-[100vh] w-full py-20 bg-transparent flex flex-col items-center overflow-hidden">
      ...
      {/* OPTIMERING 3: touch-none gör att mobil-scrollen inte fastnar. */}
      <div className="w-full h-full cursor-grab active:cursor-grabbing relative z-20 touch-none">
        ...
        {/* OPTIMERING 4: dpr={[1, 1.5]} hindrar MacBook Retina-skärmar från att överarbeta grafikkortet */}
        <Canvas camera={{ position: [0, 0, 22], fov: 45 }} dpr={[1, 1.5]} gl={{ antialias: false, powerPreference: "high-performance" }}>
